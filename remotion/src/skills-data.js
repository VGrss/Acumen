export const skills = [
  ...
  },
  {
    ...
    borderColor: "#b8d4b8",
    hoverColor: "#8cba8c",
    tagline: "Find problems & opportunities",
    steps: [
      "Metric health scan",
      "Value delivery audit",
      "Five Whys with evidence",
      "Problems & opportunities out",
    ],
  },
  {
    id: "workshop",
    ...
    borderColor: "#b4c8e8",
    hoverColor: "#8aaddb",
    tagline: "Diverge on solutions",
    steps: [
      "One problem in",
      "10 different solution shapes",
      "Collapse look-alikes",
      "Converge, hand to /increment",
    ],
  },
  {
    id: "roadmap",
